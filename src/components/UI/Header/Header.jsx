            ...
            <header className="sticky top-0 z-50 bg-[#fff]">
                        ...
                        <div className='flex gap-3 ml-auto'>
                            <div className="flex ml-auto">
                                <Link to="#_" className="outlineBtn relative inline-flex items-center px-10 py-2 overflow-hidden text-lg font-medium dark:border-gray-700 text-gray-600 border-2 border-green-600 rounded-full hover:text-white group hover:bg-gray-50">
                                    <span className="absolute left-0 block w-full h-0 transition-all dark:bg-gray-700 bg-green-600 opacity-100 group-hover:h-full top-1/2 group-hover:top-0 duration-400 ease"></span>
                            ...
                            <div className="flex ml-auto">
                                <Link to="#_" className="relative inline-flex items-center justify-start py-2 overflow-hidden font-medium transition-all dark:bg-gray-500 bg-green-500 px-7 rounded-xl group">
                                    <span className="absolute top-0 right-0 inline-block w-4 h-4 transition-all duration-500 ease-in-out dark:bg-gray-700 bg-green-800 rounded group-hover:-mr-4 group-hover:-mt-4">
                                        <span className="absolute top-0 right-0 w-5 h-5 rotate-45 translate-x-1/2 -translate-y-1/2 bg-white"></span>
                                    </span>
                                    <span className="absolute bottom-0 left-0 w-full h-full transition-all duration-500 ease-in-out delay-200 -translate-x-full translate-y-full dark:bg-gray-700 bg-green-600 rounded-2xl group-hover:mb-12 group-hover:translate-x-0"></span>
                ...
                <nav className="bg-[#f1f3ff]  dark:bg-gray-700 shadow-xl w-full h-[50px] flex border-t-[1px] border-t-[#a8acd5] border-b-[1px] border-b-[#a8acd5] mt-2 items-center justify-center text-center">
                    <div className="flex flex-wrap justify-between items-center mx-auto w-full max-w-[1200px] px-4 md:text-[12px] md:leading-[15px] ">
                       ...
                       <div className="flex flex-row relative cursor-pointer text-left">
                            <div className="flex items-center menu-web">
                                <ul className="flex flex-row text-[14px] dark:text-[#fff] font-roboto font-[500] justify-between capitalize mt-0 mb-0 text-center justify-items-center">
                                    {links.map((link, index) => {
                                        return (
                                            <li className="hover:bg-[#e7e7fc] dark:hover:bg-gray-400  items-center h-full text-center justify-items-center justify-center">
