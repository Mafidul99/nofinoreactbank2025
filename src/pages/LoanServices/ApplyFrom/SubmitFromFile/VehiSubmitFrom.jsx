...
const VehiSubmitFrom = () => {
    ...
    const formSubmit = (e) => {
        ...
        const templateParams = {
            ...
            fileRc: e.target['file-rc'].files[0],
            accountProof: e.target['file-bank-pass'].files[0],
            fileInsurance: e.target['file-insurance'].files[0],
            filePucc: e.target['file-pucc'].files[0],
                ...
                return (
                    <div>
                        <div className="border-[1px] dark:border-[#D6D6D6] border-green-300 border-dashed rounded-md p-4">
                            ...
                            <div className="grid grid-cols-4 gap-4 mt-4 lg:grid-cols-2 md:grid-cols-1 mb-4">
                                <div className="flex flex-col col-span-2 md:col-span-1">
                            ...
                            <div className="grid grid-cols-3 gap-4 lg:grid-cols-2 md:grid-cols-1 mt-2">
                                <div className="flex flex-col">
                                    <label htmlFor="file-pan" className="mb-2">
                                        ...
                                        <span className='text-red-500 text-[18px]'> * (PDF)</span>
                                    </label>
                                ...
                                <div className="flex flex-col">
                                    <label htmlFor="file-rc" className="mb-2">
                                        <span className='text-[15px] font-[500] dark:text-[#D6D6D6]'>Vehicle RC</span>
                                        <span className='text-red-500 text-[18px]'> * (PDF)</span>
                                    </label>
                                    <input type="file" id="file-rc" name="file-rc" className="border border-gray-300 p-2 rounded dark:bg-gray-600 dark:text-[#fff]" required />
                                </div>
                                <div className="flex flex-col">
                                ...
                                <div className="flex flex-col">
                                    <label htmlFor="file-insurance" className="mb-2">
                                        <span className='text-[15px] font-[500] dark:text-[#D6D6D6]'>Insurance Copy</span>
                                        <span className='text-red-500 text-[18px]'> * (PDF)</span>
                                    </label>
                                    <input type="file" id="file-insurance" name="file-insurance" className="border border-gray-300 p-2 rounded dark:bg-gray-600 dark:text-[#fff]" required />
                                </div>
                                <div className="flex flex-col">
                                    <label htmlFor="file-pucc" className="mb-2">
                                        <span className='text-[15px] font-[500] dark:text-[#D6D6D6]'>PUCC Copy</span>
                                        <span className='text-red-500 text-[18px]'> * (PDF)</span>
                                    </label>
                                    <input type="file" id="file-pucc" name="file-pucc" className="border border-gray-300 p-2 rounded dark:bg-gray-600 dark:text-[#fff]" required />
                                </div>
                                <div className="flex flex-col">
                                    <label htmlFor="file-photo" className="mb-2">
                                        <span className='text-[15px] font-[500] dark:text-[#D6D6D6]'>Your Photo</span>
                                        <span className='text-red-500 text-[18px]'> * (PNG, JPEG, JPG)</span>
                                    </label>
