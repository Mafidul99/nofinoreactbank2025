...
import ServImg from "../../assets/loanservice/business.png";

import { TbHeadphonesFilled } from "react-icons/tb";
import { FcOk } from "react-icons/fc";

const LoanAgainstVehicle = () => {
  return (
    <>
    <section>
            <div className='flex items-center justify-center mt-[40px]  w-ful '>
              <div className='flex flex-wrap justify-between items-center mx-auto max-w-[1200px] w-full px-4'>
                ...
                <div className='flex w-[100%] font-roboto text-[40px] tracking-[.9px] font-[800] mt-[-17px] dark:text-[#D6D6D6] uppercase'>
                  <span>Loan Against Vehicle Services</span>
                </div>
                  ...
                  <div className="items-center mb-[0px] pb-[0px] relative">
                    ...
                    <div className="items-center mb-0 justify-content-end px-3 py-4 mt-[60px] text-center text-gray-600
                      ...
                      <div className="flex items-center justify-center py-2 mb-3 mt-2 border-[1px] border-gray-400 p-2 w-44 rounded-md
                        ...
                        <Link to="/vehi-apply-from" target="_blank" className='hover:text-gray-600'>
                  ...
                  <div className="col-span-2 bg-[#f8f8f8] dark:bg-gray-700 p-4 rounded-md shadow-md my-auto">
                    <div className="flex flex-col items-start justify-center w-full ">
                      <div className="items-center justify-center w-full mb-3 text-left font-roboto text-gray-800 dark:text-[#D6D6D6]">
                        <h3 className='text-[30px] font-[700] py-1 underline uppercase'>Loan Against Vehicle Overview</h3>
                        <p className='text-[16px] py-1 text-justify'>At Nofino Rural Finance Private Limited, our Loan Against Vehicle service allows 
                          you to unlock the value of your vehicle to secure a low-interest loan. This flexible financing option provides quick access 
                          to funds while letting you continue using your vehicle, supporting your financial needs without disruption.
                        </p>
                      </div>
                      ...
                      <div className="items-center justify-center tracking-[1px] leading-[35px] w-full py-2 mb-3 text-left font-roboto text-gray-800 dark:text-[#D6D6D6]">
                        <ul className="list-unstyled text-gray-800 dark:text-[#D6D6D6] text-[16px] font-roboto">
                          ...
                          <li className='flex items-center'>
                            <span><FcOk size={23} /></span>
                            <span className='inline-block ml-2'>VEHICLE RC.</span>
                          </li>
                          <li className='flex items-center'>
                            <span><FcOk size={23} /></span>
                            <span className='inline-block ml-2'>INSURANCE COPY.</span>
                          </li>
                          <li className='flex items-center'>
                            <span><FcOk size={23} /></span>
                            <span className='inline-block ml-2'>PUCC.</span>
                          </li>
                          <li className='flex items-center'>
                            <span><FcOk size={23} /></span>
                            <span className='inline-block ml-2 '>SALE LETTER.</span>
                          </li>
                          <li className='flex items-center'>
                            <span><FcOk size={23} /></span>
                            <span className='inline-block ml-2'>AGREEMENT COPY.</span>
                          </li>
                          <li className='flex items-center'>
                            <span><FcOk size={23} /></span>
                            <span className='inline-block ml-2'>STAMP PEPER. (Rs.100)</span>
                          </li>
                        </ul>
                      </div>
                    </div>
...
export default LoanAgainstVehicle;